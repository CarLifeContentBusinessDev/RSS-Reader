  ...
  return (
    <div className={`grid gap-2 font-semibold ${className ?? ""}`}>
      ...
      <div className="relative" ref={wrapperRef}>
        ...
        {open && (
          <div
            className="absolute left-0 top-[calc(100%+0.6rem)] z-20 grid w-full gap-1 rounded-[14px] border border-panel-border bg-surface p-1.5 shadow-panel max-h-65 overflow-y-auto"
            role="listbox"
